    ...
    return (
        <label className="ml-3 mt-2.5 flex cursor-pointer items-center">
            ...
            <div className="relative" onChange={onToggleComplete}>
                ...
                <div
                    className={`absolute -left-1 -top-1 h-6 w-6 transform rounded-full bg-white shadow transition-transform ${isComplete ? 'translate-x-full bg-green-500' : 'translate-x-0 bg-gray-400'}`}
                ></div>
            </div>
